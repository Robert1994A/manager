...
! function(a) {
    ...
    var b = a(window),
        ...
        f = function(d, e, f, g) {
            ...
            if (h) i(a(h));
                ...
                var k = !1;
                g.find("." + f.errorMessageClass).each(function() {
                    return this.inputReferer === d[0] ? (k = a(this), !1) : void 0
                }), k ? e ? i(k) : k.remove() : (j = a('<div class="' + f.errorMessageClass + '"></div>'), i(j), j[0].inputReferer = d[0], g.prepend(j))
            } else {
                var l = c(d);
                j = l.find("." + f.errorMessageClass + ".help-block"), 0 === j.length && (j = a("<span></span>").addClass("help-block").addClass(f.errorMessageClass), j.appendTo(l)), i(j)
            }
        },
        g = function(b, c, d, e) {
    ...
    a.fn.validateOnBlur = function(b, c) {
        ...
        var l = this,
            m = l.closest("form"),
            n = a.formUtils.validateInput(l, b, g, m, i);
        ...
        validateInput: function(b, c, d, e, f) {
            ...
            var p = b.attr(d.validationRuleAttribute),
                q = !0;
            return p ? (a.split(p, function(h) {
                ...
                var j = null;
                return ("keyup" !== f || i.validateOnKeyUp) && (j = i.validatorFunction(g, b, d, c, e)), j ? void 0 : (q = null, null !== j && (q = b.attr(d.validationErrorMsgAttribute + "-" + h.replace("validate_", "")), q || (q = b.attr(d.validationErrorMsgAttribute), q || (q = c[i.errorMessageKey], q || (q = i.errorMessage)))), !1)
            }, " "), "string" == typeof q ? (b.trigger("validation", !1), h.errorMsg = q, h.isValid = !1, h.shouldChangeDisplay = !0) : null === q ? h.shouldChangeDisplay = d.addValidClassOnAll : (b.trigger("validation", !0), h.shouldChangeDisplay = !0), "function" == typeof d.onElementValidate && null !== q && d.onElementValidate(h.isValid, b, e, q), h) : (h.shouldChangeDisplay = d.addValidClassOnAll, h)
        },
