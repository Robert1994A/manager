							...
							<c:when test="${found == false}">
								<div class="alert alert-warning alert-dismissible">
									...
									please access the following link: <a class="btn btn-primary"
										href="${pageContext.request.contextPath}/generate_certificate">Generate
										certificate</a>
								</div>
							</c:when>
							<c:otherwise>
											...
											<c:forEach items="${keystores}" var="keyStore">
												<tr>
													...
													<td><a class="btn btn-default"
														href="${pageContext.request.contextPath}/export_certificate/${keyStore.id}">Export
															certificate</a></td>
													<td><a class="btn btn-default"
														href="${pageContext.request.contextPath}/export_privateKey/${keyStore.id}">Export
															private key</a></td>
													<td>
														<div class="btn-group">
															<a class="btn btn-default"
																href="${pageContext.request.contextPath}/certificate_details/${keyStore.id}"><i
																class="fa fa-eye"></i> View details</a> <a
																class="btn btn-default"
																href="${pageContext.request.contextPath}/generate_csr/${keyStore.id}">Generate
																CSR</a>
															<!-- <button type="button"
