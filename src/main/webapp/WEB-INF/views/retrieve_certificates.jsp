				...
				<div class="box">
					...
					<div class="box-body">
						<form id="retrieve-certificate-form"
							action="${pageContext.request.contextPath}/retrieve_certificate">
							<div class="box-body">
								<div class="row">
								...
								<div class="row">
									...
									<div class="form-group col-xs-6">
										<input type="text" name="host" disabled="disabled" class="form-control" />
									</div>
									<div class="form-group col-xs-3">
										<input type="text" name="port" disabled="disabled" class="form-control" />
									</div>
								</div>
							</div>
							<!-- /.box-body -->
