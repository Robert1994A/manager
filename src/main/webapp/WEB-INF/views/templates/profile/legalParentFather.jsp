	...
	<div class="page-header page-header-default"
		...
		<div class="page-header-content">
			<div class="page-title">
				<h5>
					<span class="text-semibold">Legal Parent Father</span>
				</h5>
			</div>
			<div class="heading-elements">
				<ul class="breadcrumb heading-text">
					...
					<li class="active">Legal Parent Father</li>
				</ul>
			</div>
...
<form:form method="POST" id="addLegalParentFather_form"
	commandName="legalParentFather">
	<div class="panel panel-flat">
		<div class="panel-body">
			<fieldset>
				<div class="form-group">
					<label>Enter your father first name:</label>
					<form:input cssClass="form-control" path="firstName"></form:input>
				</div>

				<div class="form-group">
					<label>Enter your father last name:</label>
					<form:input cssClass="form-control" path="lastName" />
				</div>

				<div class="form-group">
					<label>Enter your father education level:</label>
